...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        MainApp mainApp = new MainApp(outletSessionBean, employeeSessionBean, rentalRateSessionBean, modelSessionBean, categorySessionBean, carSessionBean, customerSessionBean);
        mainApp.runApp();
    }
